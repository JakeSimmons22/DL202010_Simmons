...
\begin{figure}[ht]\centering				
	\includegraphics[width=1\textwidth]{lab1_example_screenshot(1).PNG}
		Adjust size: height=1 %(length)
		width=1 (length)
		scale=1 %(0 to 1)
		Rotate: angle=1 %(degrees)
		Cropping: trim=1 2 3 4 %(order is: left bottom right top)
		clip %(this removes what you just trimmed)
		Choose page of a pdf: page=1
